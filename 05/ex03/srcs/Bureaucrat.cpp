...
/*   Updated: 2022/11/15 23:52:12 by jallerha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(Form const & form)
{
	...
	{
		form.execute(*this);
		std::cout << MAGENTA1 << _name << RESET << " executed " << MAGENTA2 << form.getName() << RESET << std::endl;
	}
	catch(const std::exception& e)
	{
		std::cout << RED1 << _name << RESET << " couldn't execute " << MAGENTA2 << form.getName() << RESET << " because " << RED1 << e.what() << RESET << std::endl;
	}
}
